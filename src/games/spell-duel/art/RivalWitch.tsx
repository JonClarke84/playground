import type { RivalPalette } from '../progression'
...
interface RivalWitchProps {
  mood?: RivalMood
  /** Recolour for the different exam rivals; defaults to Nix. */
  palette?: RivalPalette
}

/**
 * The mischievous rival student, hovering on her broom.
 * Never scary: a smirking classmate, not a villain. Canvas 260×220.
 */
export function RivalWitch({ mood = 'smug', palette = NIX_PALETTE }: RivalWitchProps) {
  return (
